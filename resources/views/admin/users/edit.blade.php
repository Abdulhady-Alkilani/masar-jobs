                    ...
                    <div class="card-body">
                         <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                <option value="" disabled {{ old('type', $user->type ?? '') == '' ? 'selected' : '' }}>-- Select Type --</option>
                                <option value="خريج" {{ old('type', $user->type ?? '') == 'خريج' ? 'selected' : '' }}>Graduate</option>
                                <option value="خبير استشاري" {{ old('type', $user->type ?? '') == 'خبير استشاري' ? 'selected' : '' }}>Consultant</option>
                                <option value="مدير شركة" {{ old('type', $user->type ?? '') == 'مدير شركة' ? 'selected' : '' }}>Company Manager</option>
                        ...
                        <div class="mb-3">
                             ...
                             <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                ...
                                <option value="مفعل" {{ old('status', $user->status ?? '') == 'مفعل' ? 'selected' : '' }}>Active</option>
                                <option value="معلق" {{ old('status', $user->status ?? '') == 'معلق' ? 'selected' : '' }}>Pending / Inactive</option>
                                <option value="محذوف" {{ old('status', $user->status ?? '') == 'محذوف' ? 'selected' : '' }}>Deleted / Banned</option>
                             </select>
