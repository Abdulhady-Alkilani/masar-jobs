                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">
                            @if($upgradeRequest->user)
                                <a href="{{ route('admin.users.show', $upgradeRequest->user) }}">{{ $upgradeRequest->user->username }}</a> ({{ $upgradeRequest->user->first_name }} {{ $upgradeRequest->user->last_name }})
                            @else
                                User not found
                            @endif
                        </dd>
            ...
            @else
                <div class="alert alert-light" role="alert">
                    This request has already been processed.
                     <a href="{{ route('admin.users.show', $upgradeRequest->user_id) }}" class="alert-link">View user profile</a>.
                </div>
            @endif
        </div>
    </div>
